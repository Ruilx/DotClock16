...
## Hardware
* MCU: ESP32-DOWDQ6 with 2.4GHz Wifi & Bluetooth
* FLASH: 25Q32 4MB
* UART: CH340C
...
| 8    | GPIO_5                         | 19  | GPIO_32            |
| 9    | GPIO_18 VSPI_SCK I2C0_SCL      | 18  | GPIO_35            |
| 10   | GPIO_23 VSPI_MOSI              | 17  | GPIO_34            |
| 11   | GPIO_19 VSPI_MISO I2C0_SDA     | 16  | EN                 |
| 12   | GPIO_22                        | 15  | VN GPIO_39         |
| 13   | 3V3                            | 14  | VP GPIO_36         |
```
...
| 6   | GND      |
```
7. SPI NAND Flash connector (optional)
```
2.54 * 1 * 6
| PIN | FUNCTION |
|----:|:---------|
...
2. 1 * DS1307 & 24C32 & DS18B20 Connector
3. 1 * 16*64 F3.75 Red LED Board Connector
4. 1 * DS3231 Connector (Not used)
5. 1 * SD Card Connector (Not used)
6. 1 * SPI NAND Flash Connector (Not used)
7. 1 * SPI LCD connector (Not used)
8. 1 * MAX7219 LED Matrix Connector (not used)
9. 1 * Type-C USB Power Supply Connector
10. 1 * LDO 5V to 3.3V Voltage Level Converter
11. 1 * Reset button
